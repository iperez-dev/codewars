...
function isPrime(num) {
  // Check if num is less than 2 or divisible by 2 (excluding 2 itself)
...
function revrot(str, sz) {
  ...
  for (let i = 0; i + sz <= str.length; i += sz) {
    ...
    const sum = chunk.split('').reduce((acc, curr) => acc + parseInt(curr), 0);
...
// Test cases
console.log(revrot("123456987654", 6));     // Output: "234561876549"
console.log(revrot("123456987653", 6));     // Output: "234561356789"
console.log(revrot("66443875", 4));         // Output: "44668753"
console.log(revrot("66443875", 8));         // Output: "64438756"
console.log(revrot("664438769", 8));        // Output: "67834466"
console.log(revrot("123456779", 8));        // Output: "23456771"
console.log(revrot("", 8));                 // Output: ""
console.log(revrot("123456779", 0));        // Output: ""
console.log(revrot("563000655734469485", 4));// Output: "0365065073456944"
...
// Example usage
console.log(encryptThis("Hello")); // Output: "72olle"
console.log(encryptThis("good")); // Output: "103doo"
console.log(encryptThis("hello world")); // Output: "104olle 119drlo"
...
function solve(s) {
  ...
  const getValue = (substring) => {
      return Array.from(substring).reduce((acc, char) => acc + (char.charCodeAt(0) - 96), 0);
  };
  
  // Split the string on vowels to get consonant substrings
  const consonantSubstrings = s.split(/[aeiou]/);
  
  // Calculate the value for each substring and find the maximum value
  const maxValue = Math.max(...consonantSubstrings.map(getValue));
  
  return maxValue;
}

// Example usage
console.log(solve("zodiacs")); // Output: 26
